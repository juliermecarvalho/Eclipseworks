...
public class MapTarefa : IEntityTypeConfiguration<Tarefa>
{
    public void Configure(EntityTypeBuilder<Tarefa> builder)
    {
        ...
        builder.Property(x => x.Detalhes).HasColumnName("detalhes").HasMaxLength(500).IsRequired();
        ...
        builder.HasMany(x => x.Comentarios).WithOne(x => x.Tarefa).HasForeignKey(x => x.TarefaId);
